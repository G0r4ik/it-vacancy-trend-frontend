<template>
  <div class="other">
    <div class="other__inner">
      ...
      <p class="other__p">
        Некорректное название категории? Нет какой-либо технологии? Неадекватные
        цифры? Советы по развитию проекта? Нашли баги? На сайте нет вашего
        родного языка? Пишите на почту.
      </p>
